...
Practicing some more today, going to attempt to work on some JavaScript projects from FreeCodeCamp this weekend as well as some more lessons in Codecademy.Another day, some more quality coding! Started learning about the command line and React today. Creating first React app with create-react-app CLI command. Learning to navigate the files in the React app and how to run the scripts. Starting the first project with React: Ravenous.
